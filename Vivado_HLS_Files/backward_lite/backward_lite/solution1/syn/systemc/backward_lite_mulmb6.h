...
// ==============================================================
#ifndef __backward_lite_mulmb6__HH__
#define __backward_lite_mulmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(backward_lite_mulmb6) {
    ...
    SC_CTOR(backward_lite_mulmb6):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
