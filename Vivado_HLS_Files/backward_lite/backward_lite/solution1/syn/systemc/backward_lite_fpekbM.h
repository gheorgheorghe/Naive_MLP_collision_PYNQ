...
// ==============================================================
#ifndef __backward_lite_fpekbM__HH__
#define __backward_lite_fpekbM__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(backward_lite_fpekbM) {
    ...
    SC_CTOR(backward_lite_fpekbM):  ACMP_fpext_comb_U ("ACMP_fpext_comb_U") {
