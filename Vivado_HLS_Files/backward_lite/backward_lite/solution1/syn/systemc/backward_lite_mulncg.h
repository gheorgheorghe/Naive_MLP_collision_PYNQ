...
// ==============================================================
#ifndef __backward_lite_mulncg__HH__
#define __backward_lite_mulncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(backward_lite_mulncg) {
    ...
    SC_CTOR(backward_lite_mulncg):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
