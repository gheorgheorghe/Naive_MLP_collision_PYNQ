...
// ==============================================================
#ifndef __backward_lite_sdilbW__HH__
#define __backward_lite_sdilbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(backward_lite_sdilbW) {
    ...
    SC_CTOR(backward_lite_sdilbW):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
