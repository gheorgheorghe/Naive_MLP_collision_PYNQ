...
// ==============================================================
#ifndef __backward_lite_mulocq__HH__
#define __backward_lite_mulocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(backward_lite_mulocq) {
    ...
    SC_CTOR(backward_lite_mulocq):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
