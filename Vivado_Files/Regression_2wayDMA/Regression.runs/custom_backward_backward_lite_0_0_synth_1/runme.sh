...
HD_PWD='C:/Projects/Example/Vivado_Files/Regression_2wayDMA/Regression.runs/custom_backward_backward_lite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_backward_backward_lite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_backward_backward_lite_0_0.tcl
