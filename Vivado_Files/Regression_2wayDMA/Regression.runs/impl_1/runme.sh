...
HD_PWD='C:/Projects/Example/Vivado_Files/Regression_2wayDMA/Regression.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_backward_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source custom_backward_wrapper.tcl -notrace
