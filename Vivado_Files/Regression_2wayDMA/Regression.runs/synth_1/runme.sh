...
HD_PWD='C:/Projects/Example/Vivado_Files/Regression_2wayDMA/Regression.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_backward_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_backward_wrapper.tcl
